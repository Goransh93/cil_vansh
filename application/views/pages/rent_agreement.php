<div id = "rentdiv1" class="printDocs" onmousedown='return false;' onselectstart='return false;' oncopy="return false" oncut="return false" onpaste="return false">
 <div class="Legal">

      <h3 style="font-size: 24px;">Legal Document</h3>
     
<P style="width: 100%; font-size: 14px; margin: 0;">This Rent Agreement is hereby executed at <span id="rental_property_place_agreement1" class = "bold">___</span> on <span id="rental_property_execution_date1" class = "bold"></span></P> 
...
<p style="width: 100%; font-size: 14px;" id="residential_second_section">2.<span id="tenant_title2" class = "bold">_______</span><span id="tenant_name2" class = "bold">___</span> <span id="tenant_husband2" style="display: none" class = "bold"> W/O </span>  <span id="tenant_husband_2" class = "bold">  </span>  <span id="son_of2" class = "bold"> S/o </span> <span id="tenant_father_name2" class = "bold"> </span> R/o <span id="tenant_street_address2" class = "bold">___</span>,<span id="tenant_city2" class = "bold">___</span>,<span id="tenant_state2" class = "bold">___</span>,<span id="tenant_pincode2" class = "bold">___</span>  <span id = "tenant_id_name"class="bold"> </span> <span id = "tenant_id_value"class="bold"> </span>(hereinafter jointly and severally called the “Tenant” which expression shall include his heirs, legal representatives, successors and assigns)</p>
...
<!--  third part -->
<p style="width: 100%; font-size: 14px; margin: 0;" id="residential_third_section">Now whereas the Landlord is the owner and in possession of <span id="type_of_property1" class = "bold">___</span> situated at <span id="rental_property_address1" class = "bold">___</span>, <span id="rental_property_city1" class = "bold">___</span>-<span id="rental_property_pin1" class = "bold">___</span>, <span id="rental_property_state1" class = "bold">___</span> and is ready to let out the portion of the said property consisting of Number of Room Set(<span id="rental_property_room_set1" class = "bold">___</span>), Bathrooms (<span id="rental_property_bathrooms1" class = "bold">___</span>) ,Area (<span id="rental_property_area1" class = "bold">___</span>) ,No. Of Balconies (<span id="rental_property_balconies1" class = "bold">___</span>) ,No. Of Car Parking Slots (<span id="rental_property_no_of_carparking1" class = "bold">___</span>) to the second party on monthly rent basis for <span id="purpose_of_renting1" class = "bold">___</span> )),on the request of the second party.</p> 
...
<!--  four part -->
<p style="width: 100%; font-size: 14px; margin: 0;" id="residential_four_section">1. That the rate of rent of the said House/Property is fixed at Rs. <span id="rent_amount1" class = "bold">...</span> /-(Rupees <span id="rent_amount_word" class = "bold">___</span> Only) per month.</p> 

<p style="width: 100%; font-size: 14px; margin: 0;display: none" id="commercial_four_section">1.That the rate of rent of the said Shop/Property is fixed at Rs. <span id="rent_amount2" class = "bold">...</span>/- (Rupees<span id="rent_amount2" class = "bold">___</span>Only) per month.</p>
<!-- end four part -->
<p style="width: 100%; font-size: 14px; margin: 0;">2. That the rent of the said house shall be effective from <span id="date_of_commencement1" class = "bold">___</span> and shall be continued initially for a period of <span id="duration_of_agreement1" class = "bold"> </span> months. </p>
<p style="width: 100%; font-size: 14px; margin: 0;">3. That the period of tenancy may be extended for its further period only on the option of the first party and in that event the rate of rent shall be increased @ <span id="rate_of_rent_percent1" class = "bold">___</span> after every years on its previous rent.</p>


<p style="width: 100%; font-size: 14px; margin: 0;">4. That the monthly rent shall be payable by the second party to the first party latest by the  <span id="rent_giving_date1" class = "bold">___</span> day of each English Calendar month in advance. </p> 
...
<!--  end five part -->
<!--  six part -->
<p style="width: 100%; font-size: 14px; margin: 0;" id="residential_six_section">8. That the second party shall use the rental premises only for <span id="purpose_of_renting1" class = "bold">___</span> purpose</p>
...
<p style="width: 100%; font-size: 14px; margin: 0;">9. That the second party shall pay the <span id="electricity1" class = "bold">___</span> <span id="water1" class = "bold"></span>, <span id="society1" class = "bold">___</span>, <span id="nil1" class = "bold">___</span>  charges extra than the said agreed rent to the first party regularly as and when the bills for such expenses/charges are produced by the concerned authorities. </p> 
...
<!-- (yes) -->
<p style="width: 100%; font-size: 14px; margin: 0;display: none" id="sublet_no">11. That the second party shall not sublet, part with the possession or assign the same to any person in any manner.</p>


<!-- (no) -->
<p style="width: 100%; font-size: 14px; margin: 0;display: none" id="sublet_yes">11.The second party is allowed to sublet the said premises further </p>

<!--  seven part -->
<p style="width: 100%; font-size: 14px; margin: 0;" id="residential_seven_section" style="display: none;">12. That the second party shall not make any constructions or additions or alterations in the building as well as the open space and roof without the written consent of the first party. </p> 
...
<!--  eight part -->
<p style="width: 100%; font-size: 14px; margin: 0;" id="residential_eight_section">16. That the second party shall have to give <span class="notice_period1 bold">___</span> month advance notice in writing to the first party, in case of his vacating the premises in question before the period of tenancy, and the tenancy may also be terminated by the first party by giving <span class="notice_period1 bold">_____</span> month notice to the second party for getting the premises in question vacated. </p>
...
<p style="width: 100%; font-size: 14px; margin: 0;display: none" id="commercial_nine_section">17.	That the second party shall have to give <span id="notice_period2" class = "bold">___</span> month advance notice in writing to the first party, in case of his vacating the premises in question before the period of tenancy, and the tenancy may also be terminated by the first party by giving (from user) month notice to the second party for getting the premises in question vacated.</p>
<!--  end nine part -->
<!--  start ten part -->
<p style="width: 100%; font-size: 14px; margin: 0;" id="residential_ten_section">18. That the said rental premises are pre-installed with following Utilities:
	<span id="utilities_list1" class = "bold">___</span><br>Note: Any Damage to said utilities during the rental tenure, the tenant will have to bear the repairing/replacement Charges.</p>
...
<p style="width: 100%; font-size: 14px; margin: 0; font-weight: bold;">a. Pets: The Tenant will be allowed.</p>
</div>
<div id="terms_pets_notallw" style="display: none;">
<!-- <span class = "bold" id="terms_pets1">___</span> -->
<p style="width: 100%; font-size: 14px; margin: 0; font-weight: bold;">a.Pets: Not Allowed to keep Pets.</p>
</div>

<div id="painting_terms" style="display: none">
<!-- <span class = "bold" id="terms_painting1">___</span> -->
<p style="width: 100%; font-size: 14px; margin: 0; font-weight: bold;">b. Painting: The Land Lord shall get the “Rented Property” Painted and cleaned at the time of handing over possession to tenant. The Tenant shall pay to the landlord the painting charges or get the premises painted and cleaned on termination of lease and vacating the premises</p>
</div>
<div id="food_terms" style="display: none">
<!-- <span class = "bold" id="terms_food1" >___</span> -->
<p style="width: 100%; font-size: 14px; margin: 0; font-weight: bold;">c. Food: the Tenant shall strictly cook only vegetarian food within the Leased Premises. </p>
</div>
<div id="lock_in_period_terms" style="display: none">
<!-- <span class = "bold" id="terms_lock_in_period1" >___</span> -->
<p style="width: 100%; font-size: 14px; margin: 0; font-weight: bold;">d. Lock-in Period: The Lease shall have a lock-in Period of (get from user) Months, before which termination is not possible by either parties. If either party terminated the lease during the lock-in period then they shall pay the sum equal to two months rent to the other party as penelty</p>
</div>
<div id="penalty_clause_1_terms" style="display: none">
<p style="width: 100%; font-size: 14px; margin: 0; font-weight: bold;">
<b>Penalty Clause:</b>(a)The Tenant will have to bear the penalty of Rs. <span class = "bold" id="penalty_clause_1_val">___</span>per Day for Non Payment of Rent </p>
...
<!--  end eleven part -->
<!--  start twel part -->
<p style="width: 100%; font-size: 14px; margin: 0;" id="residential_twel_section">20. That the Tenant has deposited Security amounting Rs.<span id="rent_security_deposit_amount1" class = "bold"></span>/- (Rupees <span class="bold" id="rent_security_deposit_amount_word"></span>) Via <span class="bold" id ="security_deposit_payment_mode1">cash</span>
<span id="ref">Refrence No. </span><span id="dd_check_value1" class = "bold">  </span> which shall be refundable at the time of vacation of premises by the Tenant after adjust any dues/penalty/repairing charges etc.  
</p>
...
<p style="width: 100%; font-size: 14px; margin: 0;display: none" id="commercial_fifty_section">22.	That the said rental premises are pre-installed with following Utilities:
	<span id="utilities_list2" class = "bold">___</span><br>
...
<div id="lock_in_period_terms" style="display: none">
<!-- <span class = "bold" id="terms_lock_in_period1" >___</span> -->
<p style="width: 100%; font-size: 14px; margin: 0;">d. Lock-in Period: The Lease shall have a lock-in Period of (get from user) Months, before which termination is not possible by either parties. If either party terminated the lease during the lock-in period then they shall pay the sum equal to two months rent to the other party as penelty</p>
</div>
<div id="penalty_clause_1_terms" style="display: none">
<p style="width: 100%; font-size: 14px; margin: 0;">
<b>Penalty Clause:</b>(a)The Tenant will have to bear the penalty of Rs. <span class = "bold" 
id="penalty_clause_11_val">___</span>per Day for Non Payment of Rent </p>

</div>
<div id="penalty_clause_2_terms" style="display: none">
<p>(b) The Tenant will have to bear the penalty of Rs. <span class = "bold" id="penalty_clause_22_val">___</span>
			per Day for (Over Stay )</p>
</div>
<div id="penalty_clause_3_terms" style="display: none">	
<p>(c) The Tenant will have to bear the penalty of Rs. <span class = "bold" id="penalty_clause_33_val">___</span>per Day for (Late Payment of Rent)</p>
</div>
</section>
<!--  end sixty part -->
<!--  start seventy part -->
...
aria-label="Print" 
onclick="$(this).closest('div.printDocs').printThis();">
